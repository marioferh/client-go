...
// ClusterMonitoringApplyConfiguration represents an declarative configuration of the ClusterMonitoring type for use
// with apply.
...
// ClusterMonitoring constructs an declarative configuration of the ClusterMonitoring type for use with
// apply.
...
func (b *ClusterMonitoringApplyConfiguration) WithOwnerReferences(values ...*v1.OwnerReferenceApplyConfiguration) *ClusterMonitoringApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {
