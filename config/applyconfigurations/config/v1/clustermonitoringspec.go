...
// ClusterMonitoringSpecApplyConfiguration represents an declarative configuration of the ClusterMonitoringSpec type for use
// with apply.
...
// ClusterMonitoringSpecApplyConfiguration constructs an declarative configuration of the ClusterMonitoringSpec type for use with
// apply.
