...
// UserDefinedMonitoringApplyConfiguration represents an declarative configuration of the UserDefinedMonitoring type for use
// with apply.
type UserDefinedMonitoringApplyConfiguration struct {
	Mode *v1.UserDefinedMode `json:"mode,omitempty"`
}

// UserDefinedMonitoringApplyConfiguration constructs an declarative configuration of the UserDefinedMonitoring type for use with
// apply.
