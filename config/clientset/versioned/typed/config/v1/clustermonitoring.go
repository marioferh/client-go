...
func (c *clusterMonitorings) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ClusterMonitoring, err error) {
	result = &v1.ClusterMonitoring{}
	err = c.client.Get().
...
func (c *clusterMonitorings) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ClusterMonitoringList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ClusterMonitoringList{}
	err = c.client.Get().
		Resource("clustermonitorings").
...
func (c *clusterMonitorings) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterMonitorings) Create(ctx context.Context, clusterMonitoring *v1.ClusterMonitoring, opts metav1.CreateOptions) (result *v1.ClusterMonitoring, err error) {
	result = &v1.ClusterMonitoring{}
	err = c.client.Post().
		Resource("clustermonitorings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterMonitoring).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clusterMonitorings) Update(ctx context.Context, clusterMonitoring *v1.ClusterMonitoring, opts metav1.UpdateOptions) (result *v1.ClusterMonitoring, err error) {
	result = &v1.ClusterMonitoring{}
	err = c.client.Put().
		Resource("clustermonitorings").
...
func (c *clusterMonitorings) UpdateStatus(ctx context.Context, clusterMonitoring *v1.ClusterMonitoring, opts metav1.UpdateOptions) (result *v1.ClusterMonitoring, err error) {
	result = &v1.ClusterMonitoring{}
	err = c.client.Put().
		Resource("clustermonitorings").
		Name(clusterMonitoring.Name).
...
func (c *clusterMonitorings) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *clusterMonitorings) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterMonitorings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ClusterMonitoring, err error) {
	result = &v1.ClusterMonitoring{}
...
func (c *clusterMonitorings) Apply(ctx context.Context, clusterMonitoring *configv1.ClusterMonitoringApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ClusterMonitoring, err error) {
...
func (c *clusterMonitorings) ApplyStatus(ctx context.Context, clusterMonitoring *configv1.ClusterMonitoringApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ClusterMonitoring, err error) {
	if clusterMonitoring == nil {
		return nil, fmt.Errorf("clusterMonitoring provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
