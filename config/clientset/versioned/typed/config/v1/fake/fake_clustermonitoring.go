...
func (c *FakeClusterMonitorings) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ClusterMonitoring, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(clustermonitoringsResource, name), &v1.ClusterMonitoring{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterMonitorings) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ClusterMonitoringList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(clustermonitoringsResource, clustermonitoringsKind, opts), &v1.ClusterMonitoringList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeClusterMonitorings) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(clustermonitoringsResource, opts))
}
...
func (c *FakeClusterMonitorings) Create(ctx context.Context, clusterMonitoring *v1.ClusterMonitoring, opts metav1.CreateOptions) (result *v1.ClusterMonitoring, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(clustermonitoringsResource, clusterMonitoring), &v1.ClusterMonitoring{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ClusterMonitoring), err
...
func (c *FakeClusterMonitorings) Update(ctx context.Context, clusterMonitoring *v1.ClusterMonitoring, opts metav1.UpdateOptions) (result *v1.ClusterMonitoring, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(clustermonitoringsResource, clusterMonitoring), &v1.ClusterMonitoring{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ClusterMonitoring), err
...
func (c *FakeClusterMonitorings) UpdateStatus(ctx context.Context, clusterMonitoring *v1.ClusterMonitoring, opts metav1.UpdateOptions) (*v1.ClusterMonitoring, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clustermonitoringsResource, "status", clusterMonitoring), &v1.ClusterMonitoring{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ClusterMonitoring), err
...
func (c *FakeClusterMonitorings) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(clustermonitoringsResource, listOpts)
...
func (c *FakeClusterMonitorings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ClusterMonitoring, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustermonitoringsResource, name, pt, data, subresources...), &v1.ClusterMonitoring{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ClusterMonitoring), err
...
func (c *FakeClusterMonitorings) Apply(ctx context.Context, clusterMonitoring *configv1.ClusterMonitoringApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ClusterMonitoring, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustermonitoringsResource, *name, types.ApplyPatchType, data), &v1.ClusterMonitoring{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ClusterMonitoring), err
...
func (c *FakeClusterMonitorings) ApplyStatus(ctx context.Context, clusterMonitoring *configv1.ClusterMonitoringApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ClusterMonitoring, err error) {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(clustermonitoringsResource, *name, types.ApplyPatchType, data, "status"), &v1.ClusterMonitoring{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1.ClusterMonitoring), err
